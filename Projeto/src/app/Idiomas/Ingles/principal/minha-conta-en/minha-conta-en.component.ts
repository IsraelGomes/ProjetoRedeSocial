...
@Component({
  selector: 'minha-conta-en',
  templateUrl: './minha-conta-en.component.html',
  styleUrls: ['./minha-conta-en.component.css']
})
export class MinhaContaEnComponent implements OnInit {
  private nome: string;
