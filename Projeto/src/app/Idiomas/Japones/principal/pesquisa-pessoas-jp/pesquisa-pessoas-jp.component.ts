...
@Component({
  selector: 'pesquisa-pessoas-jp',
  templateUrl: './pesquisa-pessoas-jp.component.html',
  styleUrls: ['./pesquisa-pessoas-jp.component.css']
})
export class PesquisaPessoasJpComponent implements OnInit {
