...
@Component({
  selector: 'minha-conta-jp',
  templateUrl: './minha-conta-jp.component.html',
  styleUrls: ['./minha-conta-jp.component.css']
})
export class MinhaContaJpComponent implements OnInit {
  private nome: string;
